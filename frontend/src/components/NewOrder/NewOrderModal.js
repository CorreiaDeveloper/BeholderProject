    ...
    useEffect(() => {
        ...
        if (order.type === "ICEBERG") {
            ...
            if (icebergQty && icebergQty < parseFloat(symbol.minLotSize)) {
                btnSend.current.disabled = true;
                return setError(`Min Lot Size Iceberg ${symbol.minLotSize}`);
            }
        }
                        ...
                        <div className='form-group'>
                            ...
                            <div className='row'>
                                <div className={getIcebergClasses(order.type)}>
                                    <QuantityInput id="icebergQty" text="Iceberg Qty:" symbol={symbol} side={order.side} wallet={props.wallet} price={order.price} onChange={onInputChange} />
                                </div>
